package dev.lone64.NMSLib.nms.version.v1_19_R1.nbt;
...
@Getter
public class NBTEntityImpl_v1_19_R1 implements NBTEntity {
    private final Entity entity;
    private final CompoundTag compoundTag;

    public NBTEntityImpl_v1_19_R1(Object entity) {
        this.entity = ((CraftEntity) entity).getHandle();
        this.compoundTag = new CompoundTag();
        this.entity.load(this.compoundTag);
    }

    public NBTEntity setTag(String key, Tag value) {
