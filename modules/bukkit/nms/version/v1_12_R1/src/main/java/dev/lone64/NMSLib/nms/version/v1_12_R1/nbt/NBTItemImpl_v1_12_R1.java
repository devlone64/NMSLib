package dev.lone64.NMSLib.nms.version.v1_12_R1.nbt;
...
public class NBTItemImpl_v1_12_R1 implements NBTItem {
    private final ItemStack item;
    private final NBTTagCompound compoundTag;

    public NBTItemImpl_v1_12_R1(Object item) {
        this.item = CraftItemStack.asNMSCopy((org.bukkit.inventory.ItemStack) item);
        this.compoundTag = this.item.getTag() == null ? new NBTTagCompound() : this.item.getTag();
    }
