...
@Getter
public class NBTEntityImpl_v1_21_R4 implements NBTEntity {
    private final Entity entity;

    public NBTEntityImpl_v1_21_R4(Entity entity) {
        this.entity = entity;
    }
    ...
    public boolean hasTag(String key) {
        key = key.replace("-", "_").replace(" ", "_").toLowerCase();
        return getPersistentDataContainer().has(Objects.requireNonNull(NamespacedKey.fromString("nms_tag_entity:%s".formatted(key))));
    }
}