...
public class NBTItemImpl_v1_20_R4 implements NBTItem {
    private final ItemStack item;
    private final ItemMeta meta;

    public NBTItemImpl_v1_20_R4(ItemStack item) {
        this.item = item;
    ...
    public boolean hasTag(String key) {
        key = key.replace("-", "_").replace(" ", "_").toLowerCase();
        return this.getPersistentDataContainer().has(NamespacedKey.fromString("nms_tag:%s".formatted(key)));
    }
