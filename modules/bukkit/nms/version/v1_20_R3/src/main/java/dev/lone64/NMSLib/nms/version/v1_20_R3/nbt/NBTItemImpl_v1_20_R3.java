package dev.lone64.NMSLib.nms.version.v1_20_R3.nbt;
...
public class NBTItemImpl_v1_20_R3 implements NBTItem {
    private final ItemStack item;
    private final ItemMeta meta;

    public NBTItemImpl_v1_20_R3(ItemStack item) {
        this.item = item;
    ...
    public boolean hasTag(String key) {
        key = key.replace("-", "_").replace(" ", "_").toLowerCase();
        return this.getPersistentDataContainer().has(Objects.requireNonNull(NamespacedKey.fromString("nms_tag:%s".formatted(key))));
    }
